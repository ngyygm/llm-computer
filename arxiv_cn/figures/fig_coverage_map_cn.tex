...
\node[anchor=north west, font=\footnotesize] at (-0.15, -0.6) {%
    \tikz\node[focused, minimum width=0.5cm, minimum height=0.35cm]{}; 重点覆盖 \quad
    \tikz\node[touched, minimum width=0.5cm, minimum height=0.35cm]{}; 涉及 \quad
    \tikz\node[notaddr, minimum width=0.5cm, minimum height=0.35cm]{}; 未涉及 \quad
    \tikz\node[gap, minimum width=0.5cm, minimum height=0.35cm]{}; 空白差距
};

\end{tikzpicture}
\caption{现有工作对各系统层次的覆盖情况}
