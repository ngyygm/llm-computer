...
Karpathy argued in 2023 that ``LLMs are not chatbots; they are the kernel process of a new operating system,'' where the filesystem becomes a vector database and the browser becomes internet search.
