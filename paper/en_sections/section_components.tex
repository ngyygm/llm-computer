...
\textbf{The key distinction: virtual memory is lossless; context management is lossy.}
...
Karpathy argued in 2023 that ``LLMs are not chatbots; they are the kernel process of a new operating system''~\cite{karpathy2023llmos}, where the filesystem becomes a vector database and the browser becomes internet search.
