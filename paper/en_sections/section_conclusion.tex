...
\textbf{Unified framework: the ICA six-layer model.}
...
\textbf{Paradigm mapping: from silicon to substrate.}
...
\textbf{Socio-technical analysis: the industry structure of intelligent computing.}
