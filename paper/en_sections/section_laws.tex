...
Figure~\ref{fig_beta_decay} visualises both the empirically observed U-shaped curve and the exponential decay model adopted in Law~II.
...
\paragraph{Industrial calibration with the Fountain system.}
