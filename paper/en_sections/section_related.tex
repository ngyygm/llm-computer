...
In other words, they reconceived the LLM not as a ``chatbot'' but as a ``kernel process,'' a metaphor later popularized by Karpathy~\cite{karpathy2023llmos}.
...
In early 2026, Codex~CLI introduced a subagent capability~\cite{openai_codex_subagents_2026}: the main agent can spawn specialized subagents that execute subtasks in parallel, each with its own independent context window and sandbox.
...
\input{/home/linkco/exa/llm-computer/paper/figures/fig_coverage_map.tex}
