...
\textbf{Weakest-link evaluation framework (full stack).}
...
\textbf{Substrate-independent intelligent compute stack (L1--L2).}
...
\textbf{Physical-world interface drivers (L4--L5).}
