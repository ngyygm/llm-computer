...
\node[oschip, below=7mm of g1] (o1) {Batch};
\node[oschip, below=7mm of g2] (o2) {Multiprogramming};
\node[oschip, below=7mm of g3] (o3) {Time-sharing};
\node[oschip, below=7mm of g4] (o4) {Modern OS};
\node[oschip, below=7mm of g5] (o5) {Trusted OS};
...
\node[font=\sffamily\tiny\itshape, text=green!40!black, anchor=east]
    at (axis cs:4.48,0.86) {Target: $F{>}0.8,\;E{>}0.8$};
...
\node[font=\sffamily\tiny\itshape, text=timelineDark, anchor=west]
    at (axis cs:4.55,3.3) {$S{>}3.3$};
