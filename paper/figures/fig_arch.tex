\begin{figure}[htbp]
    ...
    % ============================================================
    % BYPASS ARROWS (彻底放弃 |-，使用严格三段点对点坐标连线)
    % ============================================================
    
    % LEFT bypass: L5 到 L2 Core (向左偏置增加到 -2.4，绕开新背景)
    \draw[bypass]
    ...
    % RIGHT bypass 1: L4 到 L3 【修改点】：向右拉宽了线 (1.6)，并强制最后一段为水平向左
    \draw[bypass]
        (L4.east) -- ++(1.6,0) coordinate (br1) -- (br1 |- L3.east) -- (L3.east);
    
    % RIGHT bypass 2: L5 到 L1 (向右偏置增加到 2.4，绕开新背景)
    \draw[bypass]
