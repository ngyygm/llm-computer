...
\end{tikzpicture}
\caption{Dual-plane architecture. The probabilistic execution plane (orange) is weighted toward L1--L3 and the deterministic control plane (blue) toward L4--L5; the dashed line marks the primary-weighting crossover around L3--L4 (with L4 as a transition layer), a graded interface rather than a hard partition (Section~\ref{sec:dual-plane-icam}).}
