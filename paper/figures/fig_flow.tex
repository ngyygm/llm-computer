\begin{figure}[h]
    ...
    % ============================================================
    % 【修改点】：进一步向两侧推开中心点，并加大半宽，让色块横向极致舒展
    ...
    \def\yTop{1.8}    % 背景框顶部边界
    \def\yBot{-8.3}   % 背景框底部边界
    
    \def\yReq{2.8}    % 顶部 User Request 框
    \def\ySplit{2.1}  % 顶部线段分流点
    ...
    \def\yMerge{-9.1} % 底部 Merge 汇合点
    \def\yResp{-10.1} % 底部 Output 框
    ...
    %  INPUT
    % ============================================================
    % 【修改点】：同步拉宽灰色的输入框，使其与变宽的底层色块对齐 (17.5cm)
