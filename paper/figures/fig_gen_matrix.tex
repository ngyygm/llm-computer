\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        rowlabel/.style={
            % row-label width narrowed to 2.8cm to fix frame overflow and overlap
    ...
    % Row label header
    % x-position shifted to 1.3 to separate from the column block (starts at 3.9)
    ...
    % legend coordinates nudged to centre under the table
