\begin{figure}[h]
    ...
    \node[cell, fill=ra6, draw=ra6!70!white] (L6P) at (0, 6.6)
        {\textbf{Distributed Inference}\\[2pt]{\scriptsize Coordination}};
    \node[cell, fill=ra6, draw=ra6!70!white] (L6D) at (5.8, 6.6)
        {\textbf{Distributed Governance}\\[2pt]{\scriptsize Consensus}};
    
    % ============================================================
    %  L5 row – y = 5.4
    % ============================================================
    \node[cell, fill=ra5, draw=ra5!70!white] (L5P) at (0, 5.4)
        {\textbf{Semantic I/O}\\[2pt]{\scriptsize Interpretation}};
    \node[cell, fill=ra5, draw=ra5!70!white] (L5D) at (5.8, 5.4)
        {\textbf{Protocol Validation}\\[2pt]{\scriptsize I/O Sandboxing}};
    
    % ============================================================
    %  L4 row – y = 4.2  *** TRANSITION ZONE ***
    % ============================================================
    \node[tcell, fill=t4l] (L4P) at (0, 4.2)
        {\textbf{Agent Planning}\\[2pt]{\scriptsize Tool Selection}};
    \node[tcell, fill=t4r] (L4D) at (5.8, 4.2)
        {\textbf{Permission Enforcement}\\[2pt]{\scriptsize Execution Monitoring}};
    
    % ============================================================
    %  L3 row – y = 3.0
    % ============================================================
    \node[cell, fill=ra3, draw=ra3!70!white] (L3P) at (0, 3.0)
        {\textbf{Context Prioritization}\\[2pt]{\scriptsize Relevance Scoring}};
    \node[cell, fill=ra3, draw=ra3!70!white] (L3D) at (5.8, 3.0)
        {\textbf{Memory Allocation}\\[2pt]{\scriptsize Context Window Enforcement}};
    
    % ============================================================
    %  L2 row – y = 1.8
    % ============================================================
    \node[cell, fill=ra2, draw=ra2!70!white] (L2P) at (0, 1.8)
        {\textbf{Semantic KV-Cache}\\[2pt]{\scriptsize Matching $\cdot$ Prefix Reuse}};
    \node[cell, fill=ra2, draw=ra2!70!white] (L2D) at (5.8, 1.8)
        {\textbf{Cache Capacity Mgmt}\\[2pt]{\scriptsize Eviction Policy}};
    
    % ============================================================
    %  L1 row (bottom) – y = 0.6
    % ============================================================
    \node[cell, fill=ra1, draw=ra1!70!white] (L1P) at (0, 0.6)
        {\textbf{Token Generation}\\[2pt]{\scriptsize Sampling $\cdot$ Beam Search}};
    \node[cell, fill=ra1, draw=ra1!70!white] (L1D) at (5.8, 0.6)
        {\textbf{Inference Scheduling}\\[2pt]{\scriptsize Batch Management}};
