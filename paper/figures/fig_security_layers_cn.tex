...
\node[govlabel, anchor=east] at (-6.6, 0) {治理监督\\(Governor)};
...
\node[font=\scriptsize, anchor=west] at (-4.5, -4.8) {%
    \tikz\fill[blue!60!black] (0,0) rectangle (0.25,0.25);~经典安全层 \quad
    \tikz\fill[orange!70!black] (0,0) rectangle (0.25,0.25);~模型原生安全层%
};

\end{tikzpicture}
\caption{基于ICAM分层的安全防护架构}
